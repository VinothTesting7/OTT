...
public class VerifyEBooksDownloadsLockUnlockInterruptionFunctionality extends BaseTestV2 {

	String testName = "VerifyEBooksDownloadsLockUnlockInterruptionFunctionality";
	@Test(dataProvider = "getData")
	public void loginTest(Hashtable<String, String> data) throws Exception{
	if(GlobalVariables.break_Flag)
		throw new SkipException("Skipping the test as it reaches to Home page");
	test = rep.startTest("Verify  E-Books Downloads Interruptions Functionality - Lock/Unlock");
	test.log(LogStatus.INFO, "Starting the test for Lock/Unlock Interruption during Books Download in Progress Functionality - "+VootConstants.DEVICE_NAME);
	// Check run mode
	...
	// downloadspagev2.deleteDownload();
	 ...
	 System.out.println("Book title is - "+ebookTitle);
	 ...
	 Utilities.verticalSwipe(driver, homepagev2.downloadsTab);
	    ...
	    Utilities.verticalSwipe(driver);
	    	 try{
	    		 ...
	    		 String xpath3="*[@resource-id='com.viacom18.vootkids:id/parent_download_item' and contains(@content-desc,'DOWNLOAD_COMPLETE')]";
	    		 try{
