...
public class VerifyKillLaunchInterruptionDuringEpisodeDownloadFunctionalityTest extends BaseTestV2 {

	String testName = "VerifyKillLaunchInterruptionDuringEpisodeDownloadFunctionalityTest";
	@Test(dataProvider = "getData")
	public void loginTest(Hashtable<String, String> data) throws Exception{
	if(GlobalVariables.break_Flag)
		throw new SkipException("Skipping the test as it reaches to Home page");
	test = rep.startTest("Verify Kill/Open App Interruption During Episode Download Functionality Test");
	...
	int killrow=xls.getRowCount("Smoke_Results")+1;
	xls.setCellData("Smoke_Results", "Testcase Name",killrow, "Verify if downloading content is resumed post Killing & Opening the app");	
			...
			BasePageV2.reportFail("Failed to find Downloads Tab in My Stuff");
			    ...
			    if(Utilities.explicitWaitClickable(driver, downloadspagev2.editDownloadsScreen, 5))
				{
			    	...
			    	for(int i=0;i<downloadTitles.size();i++)
			    	{
			    	        ...
			    	        BasePageV2.reportFail("Episode Title - "+downloadTitles.get(i)+" is not found in Edit Downloads Screen killing and opening the App");
			    	}
			    	  ...
			    	  {
			    		  BasePageV2.reportFail("Download cancelled after killing and opening the App");
			    	  }
			    	 else
