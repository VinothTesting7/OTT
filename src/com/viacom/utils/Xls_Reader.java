...
public class Xls_Reader {
	...
	//Changing the Data in particular cell from code
	public void changeCellData(String testcaseName,String word,int no) throws IOException
    {
    ...
    workbook.getSheet("Data").getRow(testCaseRowNum+2).getCell(1).setCellValue(word);
