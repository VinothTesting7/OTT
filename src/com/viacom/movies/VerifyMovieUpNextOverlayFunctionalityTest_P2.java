...
// Author  - Suresh 
public class VerifyMovieUpNextOverlayFunctionalityTest_P2 extends BaseTestV2 {
	
String testName = "VerifyMovieUpNextOverlayFunctionalityTest_P2";
	...
	test = rep.startTest("VerifyMovieUpNextOverlayFunctionalityTest_P2");
	test.log(LogStatus.INFO, "Starting the test for Verifying the VerifyMovieUpNextOverlayFunctionalityTest_P2 functionality: "+VootConstants.DEVICE_NAME);
	// Check run mode
	...
	// VK_2104	- Verify the functionality of character image in Upnext overlay
	   ...
	   //Check for sub Title	  				  
		  if(Utilities.explicitWaitVisible(driver, playerpagev2.playerSubTitle, 10))
		  {
			  ...
			  if(subtitletext.equalsIgnoreCase(subtitletext2)) {
				  test.log(LogStatus.PASS,"Verify the functionality of character image in Upnext overlay");
			  if(!Utilities.setResultsKids("VK_2104", "Pass")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");
			  }else {
				  test.log(LogStatus.FAIL,"Verify the functionality of character image in Upnext overlay");
				  if(!Utilities.setResultsKids("VK_2104", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");
			  }
