...
//VK_2323 - Verify the functionality when user taps on Favorite icon from audio player for the 1st time:
//VK_2325 - Verify the functionality when user taps on Favorite icon from Audio player from 2nd content onwards:
//VK_2326 - Verify the functionality when user taps on Favorite icon from Reader for the 1st time:
//VK_2328 - Verify the functionality when user taps on Favorite icon from Reader from 2nd content onwards:

public class VerifyFavoriteIconFunctionalityInAudioEbookPlayerTest extends BaseTestV2 {
	String testName = "VerifyFavoriteIconFunctionalityInAudioEbookPlayerTest";
	@Test(dataProvider = "getData")
	public void loginTest(Hashtable<String, String> data) throws Exception{
	if(GlobalVariables.break_Flag)
		throw new SkipException("Skipping the test as it reaches to Home page");
	test = rep.startTest("VerifyFavoriteIconFunctionalityInAudioEbookPlayerTest");
	...
	//Click on the first carousal item
	 ...
	 test.log(LogStatus.INFO, "Playing any of the audio content from carousal");
		  if(Utilities.explicitWaitVisible(driver,playerpagev2.audioPlayerCloseButton, 60)) {
				  test.log(LogStatus.INFO, "Verifying the Favorite icon functionality of audio Player");	  
					...
					{
						if(Utilities.explicitWaitClickableNew(driver, listenpagev2.audioPlayerUnFavouriteButton, 30))
						{
							listenpagev2.audioPlayerUnFavouriteButton.click();
							Thread.sleep(3000);
						}
						if(Utilities.explicitWaitVisibleNew(driver, showspagev2.favIconPopup, 30))
						{
							...
							if(Utilities.explicitWaitClickableNew(driver, showspagev2.favIconPopupOkButton, 30))
							{
								...
								Thread.sleep(3000);
								test.log(LogStatus.PASS, "Testcase : 'Verify the functionality when user taps on Favorite icon from audio player for the 1st time:' is Passed");
								  if(!Utilities.setResultsKids("VK_2323", "Pass")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");
								
							}
							else
							{
								test.log(LogStatus.FAIL, "Pop up ok button is not displayed after favoriting audio content in audio player for first time");
								  if(!Utilities.setResultsKids("VK_2323", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
							}
							
						}
						else if(Utilities.explicitWaitClickableNew(driver, listenpagev2.audioPlayerUnFavouriteButton, 30))
						{
							listenpagev2.audioPlayerUnFavouriteButton.click();
							Thread.sleep(3000);
							if(Utilities.explicitWaitVisibleNew(driver, showspagev2.favIconPopup, 30))
					...
					if(Utilities.explicitWaitVisibleNew(driver, listenpagev2.audioPlayerFavouritedButton, 30))
						{	
							test.log(LogStatus.INFO, "Favourite icon gets filled after favoriting");
						   listenpagev2.audioPlayerFavouritedButton.click();
							Thread.sleep(3000);
						}
						else
						{
					...
					{
						test.log(LogStatus.FAIL, "Favourite icon not found in player");
					}
					
					if(Utilities.explicitWaitClickableNew(driver, playerpagev2.audioPlayerCloseButton, 30))
					{
						playerpagev2.audioPlayerCloseButton.click();
					}
					else
						{
	 ...
	 watchpagev2.firstItemInCarousal.click();
	  ...
	  if(Utilities.explicitWaitVisibleNew(driver, showspagev2.showDetailPagePlayButton , 30))
		...
		BasePageV2.reportFail("Play Button is not displayed in audio Detail page");
		  ...
		  if(Utilities.explicitWaitVisible(driver,listenpagev2.audioPlayerClose, 3)) {
				  ...
				  test.log(LogStatus.INFO, "Verifying the Favorite icon functionality of audio Player");	  
					...
					if(Utilities.explicitWaitClickableNew(driver, listenpagev2.audioPlayerFavouriteButton, 30))
					{
						...
						if(!Utilities.explicitWaitVisibleNew(driver, showspagev2.favIconPopup, 5))
						{
								...
								test.log(LogStatus.PASS, "Testcase : 'Verify the functionality when user taps on Favorite icon from Audio player from 2nd content onwards:' is Passed");
								 if(!Utilities.setResultsKids("VK_2325", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
						...
						{
							if(!Utilities.setResultsKids("VK_2325", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
							test.log(LogStatus.FAIL, "Pop up is displayed after favoriting audio content in audio player for second time");
					...
					if(Utilities.explicitWaitVisibleNew(driver, listenpagev2.audioPlayerFavouriteButton, 30))
						...
						{
							test.log(LogStatus.FAIL, "Favourite icon not filled in audio player after favoriting");
						}
					}
					else
					{
	 ...
	 if (Utilities.explicitWaitVisibleNew(driver, homepagev2.allowpermissionbtn, 5))
			...
			if(Utilities.explicitWaitVisibleNew(driver, bookspagev2.bookDetailPageBookPreviewButton , 30))
			{
				bookspagev2.bookDetailPageBookPreviewButton.click();
			}
			else
			BasePageV2.reportFail("try Button is not displayed in book Detail page");
			Thread.sleep(5000);
	   	 ...
	   	 Thread.sleep(3000);
	         ...
	         Utilities.tap(driver);
				  test.log(LogStatus.INFO, "Verifying the Favorite icon functionality of book reader");	  
			
					if(Utilities.explicitWaitClickableNew(driver, playerpagev2.bookReaderSettingsButton, 30))
					{
						...
						if(Utilities.explicitWaitVisibleNew(driver, showspagev2.favIconPopup, 30))
						{
							...
							if(Utilities.explicitWaitClickableNew(driver, showspagev2.favIconPopupOkButton, 30))
							{
								showspagev2.favIconPopupOkButton.click();
								Thread.sleep(3000);
								test.log(LogStatus.PASS, "Testcase : 'Verify the functionality when user taps on Favorite icon from Reader for the 1st time:' is Passed");
								  if(!Utilities.setResultsKids("VK_2326", "Pass")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");
							
							}
							else
							{
								test.log(LogStatus.FAIL, "Pop up ok button is not displayed after favoriting book content in reader for first time");
								  if(!Utilities.setResultsKids("VK_2326", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
							}
						...
						{
							  if(!Utilities.setResultsKids("VK_2326", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
							test.log(LogStatus.FAIL, "Pop up is not displayed after favoriting book content in reader for first time");
						}
					...
					{
						test.log(LogStatus.FAIL, "reader settings button not found in reader");
					}
					Utilities.tap(driver);
					  Thread.sleep(1000);
					  driver.navigate().back();
			         ...
			         Utilities.tap(driver);
							...
							if(Utilities.explicitWaitClickableNew(driver, readpagev2.bookReaderFavButton, 30))
							{
								...
								if(!Utilities.explicitWaitVisibleNew(driver, showspagev2.favIconPopup, 5))
								{
										...
										test.log(LogStatus.INFO, "Pop up message is not displayed");
										test.log(LogStatus.PASS, "Testcase : 'Verify the functionality when user taps on Favorite icon from Reader from 2nd content onwards:' is Passed");
										  if(!Utilities.setResultsKids("VK_2328", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
								}
								else
								{
									if(!Utilities.setResultsKids("VK_2328", "Fail")) test.log(LogStatus.WARNING, "TC ID not found in the tc document");	
									test.log(LogStatus.FAIL, "Pop up is displayed after favoriting book content in reader for second time");
